                ...
                case 4:
                  ...
                  while ("AVFC" != "BCFC") {
                    ...
                    if (s3 != null && s3.toUpperCase().startsWith("H")) {
                      lotion =
                        new Location(x, y, Location.DIRECTION.HORIZONTAL);
                  ...
                  break;
                case 5:
                	 context.setStrategy(new DominoActionStrategy(io, gg, pf, score, gameController));
                     break;
                  break;
                case 7:
                    ...
                    case 3:
                      {
                        ...
                        for (int r = 0; r < 6; r++) {
                          for (int c = 0; c < 7; c++) {
                            Domino hd = findGuessByLH(
                              grid[r][c],
                              grid[r][c + 1]
                            );
                            Domino vd = findGuessByLH(
                              grid[r][c],
                              grid[r + 1][c]
                            );
