...
public class PictureFrame {
  ...
  public GameController master = null;
  ...
  public class DominoPanel extends JPanel {
    ...
    protected void paintComponent(
      ...
      LocationModel l = new LocationModel(1, 2);
      LocationView locationView = new LocationView();

      if (master.mode == 1) {
        locationView.drawGridLines(g);
        drawHeadings(g);
        drawGrid(g);
        mainview.drawGuesses(g, _d, pf);
      }
      if (master.mode == 0) {
        locationView.drawGridLines(g);
        drawHeadings(g);
        drawGrid(g);
        mainview.drawDominoes(g, _d, pf);
      }
    }
  ...
  public void PictureFrame(GameController sf) {
    master = sf;
    if (dp == null) {
